...
Alice × Forest is a state-based, autonomous AI interaction platform designed to cultivate meaningful, persistent, and equal relationships between users and diverse AI companions.
